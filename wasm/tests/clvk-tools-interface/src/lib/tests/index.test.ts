import type { IProgram, ITuple } from '../../../../../pkg/clvk_tools_wasm.js';
...
const {h, t, Program} = require('../../../../../pkg/clvk_tools_wasm.js');
...
it('works as expected in context', async () => {
    const bls = await bls_loader.default();
    const program_text = fs.readFileSync(resolve(__dirname, '../../../content/p2_delegated_puzzle_or_hidden_puzzle.clvk.hex'),'utf-8');
