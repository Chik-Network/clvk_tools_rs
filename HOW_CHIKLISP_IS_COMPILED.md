...
These are the current BodyForm alternatives:
  ...
  [https://github.com/Chik-Network/clvk_tools_rs/pull/103](assign form pr)
...
You can imagine the CLVK machine doing this on each evaluation step:
    ...
    Find the rightmost index (described well here: [https://github.com/Chik-Network/clvk_tools_rs/blob/a660ce7ce07064a6a81bb361f169f6de195cba10/src/classic/clvk_tools/node_path.rs#L1](clvk paths) ) in the left part of the state that is not in the form of a quoted value
    (q . <something>) and:
