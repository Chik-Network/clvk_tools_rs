...
compiled_code = clvk_tools_rs.compile(
    classic_code,
    ["."],
    True
)
...
compiled_code = clvk_tools_rs.compile_clvk(
...
dependencies = clvk_tools_rs.check_dependencies(
