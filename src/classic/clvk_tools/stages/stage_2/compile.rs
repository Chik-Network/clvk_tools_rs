...
use crate::classic::clvk_tools::stages::stage_2::defaults::default_macro_lookup;
use crate::classic::clvk_tools::stages::stage_2::helpers::{brun, evaluate, quote};
use crate::classic::clvk_tools::stages::stage_2::module::compile_mod;
...
fn do_com_prog_(
    ...
    /*
     * Turn the given program `prog` into a clvk program using
