...
use crate::classic::clvk_tools::clvkc::{compile_clvk, compile_clvk_text};
use crate::compiler::compiler::DefaultCompilerOpts;
use crate::compiler::comptypes::CompilerOpts;
use crate::tests::classic::run::read_json_from_file;

#[test]
fn test_compile_clvk_function_1() {
    let mut symbol_hash_table = HashMap::new();
    let bridge_hex_file = "validation_taproot.clvk2.hex";
    ...
    let read_in_hex_data =
        fs::read_to_string("resources/tests/bridgeref/validation_taproot.clvk.hex.reference")
            .expect("should exist");
...
#[test]
fn test_compile_clvk_with_previous_data() {
    let bridge_hex_file = "validation_taproot.clvk.hex";
    let bridge_hex =
        fs::read_to_string("resources/tests/bridgeref/validation_taproot.clvk.hex.reference")
